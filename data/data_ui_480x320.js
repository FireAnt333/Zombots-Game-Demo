...
class UIElement {
  ...
  toggleImage(setting) {
    console.log(`toggleImage() on ${this.name} works!`);
    if (setting === 1) {
      this.active = true;
      ...
      //console.log(`${this.name} was active`);
      this.active = false;
      //console.log(`old img.src: ${this.img.src}`);
      this.img.src = this.imgSrc0;
      //console.log(`new img.src: ${this.img.src}`);
      //console.log(`${this.name} should now be inactive`);
    } else if (!this.active) {
      //console.log(`${this.name} was inactive`);
      this.active = true;
      //console.log(`old img.src: ${this.img.src}`);
      this.img.src = this.imgSrc1;
      //console.log(`new img.src: ${this.img.src}`);
      //console.log(`${this.name} should now be active`);
    }
  }
}
...
class Button extends UIElement {
  ...
  /*toggle() {
    ...
    /*if (this.active) {
      console.log('btnDepot was active');
      this.active = false;
      console.log(`old img.src: ${btnToggleTest.img.src}`);
      btnToggleTest.img.src = btnToggleTest.imgSrc0;
      console.log(`new img.src: ${btnToggleTest.img.src}`);
    } else if (!this.active) {
      console.log('btnDepot was inactive');
      this.active = true;
      console.log(`old img.src: ${btnToggleTest.img.src}`);
      btnToggleTest.img.src = btnToggleTest.imgSrc1;
      console.log(`new img.src: ${btnToggleTest.img.src}`);
    }*/

  /* OLD TOGGLE (NOT WORKING)
  toggle(setting) {
    ...
    if (setting === 'active') {
      ...
      console.log(`invalid input in for ${this.name}.toggle()`);
    }
  }
  */
...
const elementName = new UIElement('', [0, 0], 0, 0, 0, false, '', '');
       name: string
...
const titleZombots = new UIElement('Zombots Title', [150, 72], 180, 40, 1, false, 'resources/images/ui_480x320/Other UI Components/Zombots_Title_Card_Stylized_180x40.png');

// bg = Background
const bgStart = new UIElement('Background: Start Screen', [0, 0], 480, 320, 4, false, 'resources/images/ui_480x320/Backgrounds/Background_StartMenu_480x320.png', null);
const bgLeft = new UIElement('Background: Left', [0, 34], 100, 286, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_Sidebar_100x286.png', null);
const bgRight = new UIElement('Background: Right', [380, 34], 100, 286, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_Sidebar_100x286.png', null);
const bgBottom = new UIElement('Background: Bottom', [98, 280], 284, 40, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_LowerCenter_284x40.png', null);
const bgCenterPanelPlainLeft = new UIElement('Background: Center Panel (Plain, Left)', [98, 34], 143, 248, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_CenterPanel_Plain_143x248.png');
const bgCenterPanelPlainRight = new UIElement('Background: Center Panel (Plain, Right)', [239, 34], 143, 248, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_CenterPanel_Plain_143x248.png');

const bgDepotArtwork = new UIElement('Background: Depot Artwork', [0, 34], 480, 286, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_ArtworkComingSoon_480x286.png');
const bgSavedLoadouts = new UIElement('Background: Saved Loadouts', [98, 34], 143, 248, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_CenterPanel_SavedLoadouts_143x248.png');

const bgLoadoutFilters = new UIElement('Background: Loadout Filters', [0, 34], 100, 286, 2, false, 'resources/images/ui_480x320/Backgrounds/Background_LoadoutFilters_100x286.png');

// tx = Text
const txDemoVersion = new UIElement('Demo Version', [3, 3], 130, 16, 1, false, 'resources/images/ui_480x320/Other UI Components/Zombots_Demo_V0.0.1_130x16.png');
const txSavedLoadouts = new UIElement('Text: Saved Loadouts', [100, 39], 139, 12, 0, false, 'resources/images/ui_480x320/Other UI Components/Text_CenterPanel_SavedLoadouts_139x12.png');
const txLoadoutFilters = new UIElement('Text: Loadout Filters', [0, 0], 0, 0, 0, false, '');
const txLoadoutStats = new UIElement('Text: Loadout Stats', [0, 0], 0, 0, 0, false, '');
const txItems = new UIElement('Text: Items', [0, 0], 0, 0, 0, false, '');
const txItemFilters = new UIElement('Text: Item Filters', [0, 0], 0, 0, 0, false, '');
const txItemStats = new UIElement('Text: Item Stats', [0, 0], 0, 0, 0, false, '');
const txActions = new UIElement('Text: Actions', [0, 0], 0, 0, 0, false, '');
const txBackToActions = new UIElement('Text: BackToActions', [0, 0], 0, 0, 0, false, '');
const txModifying = new UIElement('Text: Modifying', [0, 0], 0, 0, 0, false, '');

// dv = Divider
const dvCenterPanel1 = new UIElement('Divider: Center Panel V1', [0, 0], 0, 0, 0, false, '');

// da = Display Area
const daLoadoutDisplay = new UIElement('Loadout Display', [239, 34], 143, 248, 2, false, 'resources/images/ui_480x320/Other UI Components/Loadout_Display_143x248.png');
const daResourceDisplay = new UIElement('Resource Display', [380, 34], 100, 105, 2, true, 'resources/images/ui_480x320/Other UI Components/ResourceDisplayArea_ResourceNumbers_100x105.png', 'resources/images/ui_480x320/Other UI Components/ResourceDisplayArea_ResourceNames_100x105.png');
const daEquipmentDisplayCard1 = new UIElement('Equipment Display Card', [189, 0], 51, 19, 1, false, 'resources/images/ui_240x160/MEDU_Equipment_Display_Card_51x19.png', null);
const daStatusDisplay = new UIElement('MEDU Status Display', [49, 140], 142, 20, 1, false, 'resources/images/ui_240x160/MEDU_Status_Display_142x20.png', null);
...
const btnToggleTest = new Button('Toggle Test', [20, 40], 106, 36, 2, true, 'resources/images/ui_480x320/Buttons/Button_Depot_INACTIVE_106x36.png', 'resources/images/ui_480x320/Buttons/Button_Depot_ACTIVE_106x36.png', () => {
  /*if (this.active) {
    console.log('btnDepot was active');
    this.active = false;
    console.log(`old img.src: ${btnToggleTest.img.src}`);
  ...
  /*btnToggleTest.active = true;
  console.log(`btnToggleTest.active: ${btnToggleTest.active}`);
  btnToggleTest.active = false;
  console.log(`btnToggleTest.active: ${btnToggleTest.active}`);
  ...
  console.log(`btnToggleTest.img: ${btnToggleTest.img}`);
  console.log(`this.img: ${this.img}`);

  btnToggleTest.img.src = btnToggleTest.imgSrc0;
  console.log(`btnToggleTest.img.src: ${btnToggleTest.img.src}`);
  btnToggleTest.img.src = btnToggleTest.imgSrc1;
  console.log(`btnToggleTest.img.src: ${btnToggleTest.img.src}`);
  this.img.src = this.imgSrc0;
  ...
  this.img.src = this.imgSrc1;
  console.log(`this.img.src: ${this.img.src}`);
  btnActionLog('toggle test');*/
  //console.log(btnToggleTest.toggleActive);
  btnToggleTest.toggleImage();
}); // toggle
//console.log(btnToggleTest);
//btnToggleTest.toggleActive();
//console.log('----------')
//btnToggleTest.toggleActive();
//console.log(btnToggleTest.toggle)

const btnBack = new Button('Back', [0, 0], 36, 36, 2, false, 'resources/images/ui_480x320/Buttons/Button_Back_CurvedArrow_36x36.png', null, () => {
...
const btnBuildOptions = new Button('Build Options', [33, 0], 18, 18, 2, false, 'resources/images/ui_240x160/Button_BuildOptions_18x18.png', null, () => {
  btnActionLog('build options');
});
const btnDepot = new Button('Depot', [186, 0], 106, 36, 2, true, 'resources/images/ui_480x320/Buttons/Button_Depot_INACTIVE_106x36.png', 'resources/images/ui_480x320/Buttons/Button_Depot_ACTIVE_106x36.png', () => {
...
const btnEconomyDetails = new Button('Economy Details', [12, 0], 23, 18, 2, false, 'resources/images/ui_240x160/Button_EconomyDetails_23x18.png', null, () => {
...
const btnInfoCredits = new Button('Info/Credits', [184, 201], 112, 22, 1, false, 'resources/images/ui_480x320/Buttons/Button_InfoCredits_112x22.png', null, () => {
  btnActionLog('info/credits');
});
const btnLabArmory = new Button('Lab + Armory', [290, 0], 190, 36, 2, true, 'resources/images/ui_480x320/Buttons/Button_LabArmory_INACTIVE_190x36.png', 'resources/images/ui_480x320/Buttons/Button_LabArmory_ACTIVE_190x36.png', () => {
  btnLevels.toggleImage(0);
...
const btnLevels = new Button('Levels', [68, 0], 120, 36, 2, true, 'resources/images/ui_480x320/Buttons/Button_Levels_INACTIVE_120x36.png', 'resources/images/ui_480x320/Buttons/Button_Levels_ACTIVE_120x36.png', () => {
...
const btnLoadoutFilterWheeled = new Button('Loadout Filter: Wheeled', [5, 58], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Wheeled_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Wheeled_ACTIVE_90x18.png', () => {
  btnLoadoutFilterWheeled.toggleImage();
  btnActionLog('LO: Wheeled');
});
const btnLoadoutFilterBipedal = new Button('Loadout Filter: Bipedal', [5, 78], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Bipedal_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Bipedal_ACTIVE_90x18.png', () => {
  btnLoadoutFilterBipedal.toggleImage();
  btnActionLog('LO: Bipedal');
});
const btnLoadoutFilterTracked = new Button('Loadout Filter: Tracked', [5, 98], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Tracked_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Tracked_ACTIVE_90x18.png', () => {
  btnLoadoutFilterTracked.toggleImage();
  btnActionLog('LO: Tracked');
});
const btnLoadoutFilterAerial = new Button('Loadout Filter: Aerial', [5, 118], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Aerial_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Aerial_ACTIVE_90x18.png', () => {
  btnLoadoutFilterAerial.toggleImage();
  btnActionLog('LO: Aerial');
});
const btnLoadoutFilterHexipedal = new Button('Loadout Filter: Hexipedal', [5, 138], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Hexipedal_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Hexipedal_ACTIVE_90x18.png', () => {
  btnLoadoutFilterHexipedal.toggleImage();
  btnActionLog('LO: Hexipedal');
});
const btnLoadoutFilterHeadquarters = new Button('Loadout Filter: Headquarters', [5, 162], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Headquarters_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Headquarters_ACTIVE_90x18.png', () => {
  btnLoadoutFilterHeadquarters.toggleImage();
  btnActionLog('LO: Headquarters');
});
const btnLoadoutFilterWeaponFrame = new Button('Loadout Filter: Weapon Frame', [5, 182], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_WeaponFrame_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_WeaponFrame_ACTIVE_90x18.png', () => {
  btnLoadoutFilterWeaponFrame.toggleImage();
  btnActionLog('LO: Weapon Frame');
});
const btnLoadoutFilterUtilityFrame = new Button('Loadout Filter: Utlity Frame', [5, 202], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_UtilityFrame_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_UtilityFrame_ACTIVE_90x18.png', () => {
  btnLoadoutFilterUtilityFrame.toggleImage();
  btnActionLog('LO: Utility Frame');
});
const btnLoadoutFilterBlueprints = new Button('Loadout Filter: Blueprints', [5, 228], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Blueprints_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Blueprints_ACTIVE_90x18.png', () => {
  btnLoadoutFilterBlueprints.toggleImage();
  btnActionLog('LO: Blueprints');
});
const btnLoadoutFilterOwned = new Button('Loadout Filter: Owned', [5, 248], 90, 18, 1, false, 'resources/images/ui_480x320/Buttons/Button_Filter_Owned_INACTIVE_90x18.png', 'resources/images/ui_480x320/Buttons/Button_Filter_Owned_ACTIVE_90x18.png', () => {
  btnLoadoutFilterOwned.toggleImage();
  btnActionLog('LO: Owned');
});
const btnManageLoadouts = new Button('Manage Loadouts', [185, 39], 110, 16, 1, false, 'resources/images/ui_480x320/Buttons/Button_ManageLoadouts_110x16.png', null, () => {
  loadScene('depotLoadouts');
...
const btnOptions = new Button('Options', [34, 0], 36, 36, 2, false, 'resources/images/ui_480x320/Buttons/Button_Options_36x36.png', null, () => {
...
const btnStartGame = new Button('Start Game', [184, 149], 112, 22, 1, false, 'resources/images/ui_480x320/Buttons/Button_StartGame_112x22.png', null, () => {
  loadScene('depotHome');
...
const btnToggleResourceDisplay = new Button('Toggle Resource Display', [461, 120], 18, 18, 1, true, 'resources/images/ui_480x320/Buttons/Button_Info_18x18.png', 'resources/images/ui_480x320/Buttons/Button_Hashtag_18x18.png', () => {
  btnToggleResourceDisplay.toggleImage();
  daResourceDisplay.toggleImage();
});
const btnTutorials = new Button('Tutorials', [184, 175], 112, 22, 1, false, 'resources/images/ui_480x320/Buttons/Button_Tutorials_112x22.png', null, () => {btnActionLog('tutorials');});
...
let UISecLeftLevelModeSelect = [];
let UISecLeftDepotHome = [];
...
let UISecLeftTechTreeCategories = [];
let UISecLeftGameLevel = [];
let UISecRightResourceDisplay = [daResourceDisplay, btnToggleResourceDisplay];
//let UISecRightDepotLoadouts = [daResourceDisplay];
let UISecRightDepotEditor = [];
...
let UISecMidDepotEditor = [];
let UISecMidLevelSelect = [];
